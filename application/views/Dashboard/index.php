        ...
        <div class="row g-5 g-xl-8">
          ...
          <div class="col-xl-6">
            ...
            <div class="card card-xl-stretch mb-xl-8">
              ...
              <div class="card-header align-items-center border-0 mt-4">
                <h3 class="card-title align-items-start flex-column">
                  <span class="fw-bolder text-dark">Petugas Guru Piket Hari ini</span>
                  <span class="text-muted mt-1 fw-bold fs-7">Pagi S/D Sore</span>
                </h3>
                <div class="card-toolbar">
                  <!--begin::Menu-->
                  <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
              ...
              <div class="card-body pt-3">
                <!-- ============================================================ List Jadwal disini -->
                <table id="Today-Piket" style="width: 100%;" class="table-sm align-middle table-rounded table-bordered border gy-5 gs-5">
                  <thead style="background-color: #3B6D8C;">
                    <tr class="text-start text-white fw-bolder text-uppercase">
                  ...
                  <tbody class="text-dark fw-bold">
                    <?php foreach ($Pikets->result() as $piket) : ?>
                      <tr>
                        <td><?= $sch->Nama ?></td>
                        <td><?= $sch->Waktu_Piket ?></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
