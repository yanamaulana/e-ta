    ...
    <div class="col-xl-12">
        <div class="py-5">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <?php if ($Hdr_Schedules->num_rows() > 0) : ?>
                        <?php foreach ($Hdr_Schedules->result() as $Hdr_Schedule) : ?>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="fv-row mb-5" id="el-status">
                                            <?php if ($Hdr_Schedule->Approve == 0) : ?>
                                                <button type="button" class="form-control disabled btn btn-secondary"><i class="fas fa-archive"></i> Un-Approve : Archive</button>
                                            <?php elseif ($Hdr_Schedule->Approve == 1) : ?>
                                                <button type="button" class="form-control disabled btn btn-secondary"><i class="fas fa-archive"></i> Approved : Archive</button>
                        ...
                        <div class="row">
                            <div class="alert alert-dismissible bg-light-warning border border-warning border-dashed d-flex flex-column flex-sm-row w-100 p-5 mb-10">
                                ...
                                <div class="d-flex flex-column pe-0 pe-sm-10">
                                    <h5 class="mb-1">You doesnt have any archive schedule !</h5>
