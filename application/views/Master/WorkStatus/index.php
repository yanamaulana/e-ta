        ...
        <div class="card card-flush overflow-hidden h-xl-100">
            <div class="card-header py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-dark" id="table-title">List Master Data Work Status</span>
                </h3>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12">
                            <div class="fv-row mb-5">
                                ...
                                <input type="text" required class="form-control" id="Work_Status" name="Work_Status" placeholder="Work Status...">
                            </div>
                        </div>
                    </div>
                </form>
