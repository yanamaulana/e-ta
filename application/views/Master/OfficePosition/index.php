        ...
        <div class="card card-flush overflow-hidden h-xl-100">
            <div class="card-header py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-dark" id="table-title">List Data Office Position</span>
                </h3>
                    ...
                    <table id="TableData" class="table-sm align-middle display compact dt-nowrap table-rounded w-100 table-striped table-bordered border gy-5 gs-5">
                        <thead style="background-color: #3B6D8C;">
                            <tr class="text-start text-white fw-bolder text-uppercase">
                                ...
                                <th class="text-center text-white">OFFICE POSITION CODE</th>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12">
                            <div class="fv-row mb-5">
                                ...
                                <input type="text" required class="form-control" id="jabatan" name="jabatan" placeholder="Office Position...">
                            </div>
                        </div>
                        <div class="col-xl-12 col-md-12">
                            <div class="fv-row mb-5">
                                <label class="form-label">Office Position Code:</label>
                                <input type="text" required class="form-control" id="kode_jabatan" name="kode_jabatan" placeholder="Office Position Code...">
                            </div>
                        </div>
