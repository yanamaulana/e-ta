    ...
    <div class="col-xl-12">
        <div class="card card-flush overflow-hidden h-xl-100">
            ...
            <div class="card-body pt-0">
                <form class="form" id="form-petugas-upacara">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-6">
                                <div class="form-group py-3">
                                    <label for="nominal" class="col-form-label">Jabatan Upacara :</label>
                                    <div class="col-sm-10">
                                        <select required class="form-control select2" id="jabatan_upacara" name="jabatan_upacara">
                                            <option selected disabled>-Pilih Jabatan Upacara-</option>
                                            <?php foreach ($Jabatan_Upacara as $li) : ?>
                                                <option value="<?= $li->Code ?>"><?= $li->Code . ' (' . rupiah($li->Nominal) . ')' ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="d-grid gap-2 col-md-3 col-xl-3">
                            <button class="btn btn-primary btn-lg mt-3" id="submit-petugas-upacara">Submit Data Petugas Upacara &nbsp;&nbsp;&nbsp; <i class="fas fa-save fs-2"></i></button>
                        </div>
                        <hr />
                    </div>
