                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                            ...
                            <div class="menu-item">
                                <a class="menu-link <?= ($Menu == 'SubmissionAttendance') ? 'active' : null ?>" href="<?= base_url('SubmissionAttendance') ?>">
                                    ...
                                    <span class="menu-title">Pengajuan Absen</span>
                                </a>
                            </div>
                            <?php if ($Role == 'ADMINISTRATOR') : ?>
                                <div class="menu-item">
                                    <a class="menu-link <?= ($Menu == 'ApprovalAttendance') ? 'active' : null ?>" href="<?= base_url('ApprovalAttendance') ?>">
                                        ...
                                        <span class="menu-title">Approval Absen</span>
                                    </a>
                                </div>
                            <?php endif; ?>
                            <div class="menu-item">
                            ...
                            <?php if ($Role == 'ADMINISTRATOR') : ?>
                                <div class="menu-item">
                                    <div class="menu-content pt-4 pb-2">
                                        <span class="menu-section text-muted text-uppercase fs-8 ls-1 fw-bold">ADMINISTRASI PAYROLL</span>
                                    </div>
                                </div>
                                ...
                                <!-- penanda -->
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion <?= ($Menu == 'PotonganKasbon' || $Menu == 'PotonganKoperasi' || $Menu == 'PotonganPgri') ? 'hover show' : null; ?>">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                                            <span class="svg-icon svg-icon-2">
                                    ...
                                    <div class="menu-sub menu-sub-accordion <?= ($Menu == 'PotonganKasbon' || $Menu == 'PotonganKoperasi' || $Menu == 'PotonganPgri') ? 'show"' : '" style="display: none; overflow: hidden;"'; ?> kt-hidden-height=" 117">
                                        <div class="menu-item">
                                            <a class="menu-link <?= ($Menu == 'PotonganKasbon' && $this->uri->segment(2) == '') ? 'active' : null ?>" href="<?= base_url('PotonganKasbon') ?>">
                                                <span class="menu-icon">
                                                    <span class="svg-icon svg-icon-2">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link <?= ($Menu == 'PotonganKoperasi' && $this->uri->segment(2) == '') ? 'active' : null ?>" href="<?= base_url('PotonganKoperasi') ?>">
                                                <span class="menu-icon">
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link <?= ($Menu == 'PotonganPgri' && $this->uri->segment(2) == '') ? 'active' : null ?>" href="<?= base_url('PotonganPgri') ?>">
                                                <span class="menu-icon">
                                                    <span class="svg-icon svg-icon-2">
                                                        <i class="far fa-address-card fs-2"></i>
                                                    </span>
                                                </span>
                                                <span class="menu-title">Pgri</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <!-- penanda -->
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion <?= ($Menu == 'GuruPiket' || $Menu == 'Upacara') ? 'hover show' : null; ?>">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                                            <span class="svg-icon svg-icon-2">
                                        ...
                                        <span class="menu-title">PIKET & UPACARA</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <div class="menu-sub menu-sub-accordion <?= ($Menu == 'GuruPiket' || $Menu == 'Upacara') ? 'show"' : '" style="display: none; overflow: hidden;"'; ?> kt-hidden-height=" 117">
                                        <div class="menu-item">
                                            <div class="menu-content pt-4 pb-2">
                                        ...
                                        <div class="menu-item">
                                            <div class="menu-content pt-4 pb-2">
                                                <span class="menu-section text-muted text-uppercase fs-8 ls-1 fw-bold">UPACARA</span>
                                            </div>
                                        </div>
                                        <div class="menu-item">
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion <?= ($Menu == 'Rapat' || $Menu == 'OverTime') ? 'hover show' : null; ?>">
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">RAPAT & LEMBUR</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <div class="menu-sub menu-sub-accordion <?= ($Menu == 'Rapat' || $Menu == 'OverTime') ? 'show"' : '" style="display: none; overflow: hidden;"'; ?> kt-hidden-height=" 117">
                                        <div class="menu-item">
                                            <div class="menu-content pt-4 pb-2">
                                        ...
                                        <div class="menu-item">
                                            <div class="menu-content pt-4 pb-2">
                                                <span class="menu-section text-muted text-uppercase fs-8 ls-1 fw-bold">LEMBUR</span>
                                            </div>
                                        </div>
                                        <div class="menu-item">
                                            <a class="menu-link <?= ($Menu == 'OverTime' && $this->uri->segment(2) == '') ? 'active' : null ?>" href="<?= base_url('OverTime') ?>">
                                                ...
                                                <span class="menu-title">Input Lemburan</span>
                                            </a>
                                        </div>
                                        <div class="menu-item">
                                            <a class="menu-link <?= ($Menu == 'OverTime' && $this->uri->segment(2) == 'Monitoring') ? 'active' : null ?>" href="<?= base_url('OverTime/Monitoring') ?>">
                                                ...
                                                <span class="menu-title">Monitoring Lembur</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
