<div class="row g-6 g-xl-9 mb-6 mb-xl-9">
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="card h-100">
            <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                <a href="<?= base_url('Master/index_employee') ?>" class="text-gray-800 text-hover-primary d-flex flex-column">
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="card h-100">
            <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                <a href="<?= base_url('Master/index_subjects') ?>" class="text-gray-800 text-hover-primary d-flex flex-column">
                    <div class="symbol symbol-75px mb-5">
                        <img src="<?= base_url() ?>assets/Metronic/dist/assets/media/svg/files/folder-document.svg" alt="">
                    </div>
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="card h-100">
            <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                <a href="<?= base_url('Master/index_class') ?>" class="text-gray-800 text-hover-primary d-flex flex-column">
                    <div class="symbol symbol-75px mb-5">
                        <img src="<?= base_url() ?>assets/Metronic/dist/assets/media/svg/files/folder-document.svg" alt="">
                    </div>
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="card h-100">
            <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                <a href="<?= base_url('Master/index_office_position') ?>" class="text-gray-800 text-hover-primary d-flex flex-column">
                    <div class="symbol symbol-75px mb-5">
                        <img src="<?= base_url() ?>assets/Metronic/dist/assets/media/svg/files/folder-document.svg" alt="">
                    </div>
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="card h-100">
            <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                <a href="<?= base_url('Master/index_Work_Status') ?>" class="text-gray-800 text-hover-primary d-flex flex-column">
                    <div class="symbol symbol-75px mb-5">
                        <img src="<?= base_url() ?>assets/Metronic/dist/assets/media/svg/files/folder-document.svg" alt="">
                    </div>
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="card h-100">
            <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                <a href="<?= base_url('Master/index_salary') ?>" class="text-gray-800 text-hover-primary d-flex flex-column">
                    <div class="symbol symbol-75px mb-5">
                        <img src="<?= base_url() ?>assets/Metronic/dist/assets/media/svg/files/folder-document.svg" alt="">
                    </div>
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="card h-100">
            <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                <a href="<?= base_url('Master/index_allowance') ?>" class="text-gray-800 text-hover-primary d-flex flex-column">
                    <div class="symbol symbol-75px mb-5">
                        <img src="<?= base_url() ?>assets/Metronic/dist/assets/media/svg/files/folder-document.svg" alt="">
                    </div>
