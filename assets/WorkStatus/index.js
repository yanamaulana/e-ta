$(document).ready(function () {
	...
	var TableData = $("#TableData").DataTable({
		...
		ajax: {
			url: $('meta[name="base_url"]').attr('content') + "Master/DT_List_Work_Status",
			dataType: "json",
			type: "POST",
		},
		columns: [{
	...
	function Init_Submit_Form(DataForm) {
		...
		$.ajax({
			dataType: "json",
			type: "POST",
			url: $('meta[name="base_url"]').attr('content') + "Master/Store_New_Work_Status",
