...
|
*/
$config['encryption_key'] = 'E-T34ch3r-47end4nc3';
...
// DEFINING VARIABLE APPLICATION 

$config['app_name'] = 'E-Teacher Attendance';
$config['init_app_name'] = 'E-TA';
$config['company_name'] = 'SMK PGRI Karisma Bangsa';
$config['company_initial'] = 'Karbas';
$config['website'] = 'https://smkpgrikarbas.sch.id/';

// $this->config->item('app_name') cara pengambilan value dari config
